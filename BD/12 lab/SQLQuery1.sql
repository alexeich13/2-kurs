...
declare @out int;
exec @out = PAUDITORIUM_INSERT @a = '315-1',@n =  'ЛБ-К', @c =15, @t =  'd';
...
declare @m int;
exec @m = PAUDITORIUM_INSERTX @a = 'ЛК', @n = '2',@c = 15, @t = 'ЛК-Б' ,@tn = 'Аудитория';
