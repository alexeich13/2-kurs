...
VALUES ('дюх','дпнгд юкейяеи хцнпебхв','л','хяхр')
...
GO
DELETE FROM TEACHER 
WHERE TEACHER_NAME = 'дпнгд юкейяеи хцнпебхв'
SELECT * FROM TR_AUDIT
------------------------------3>
...
RETURN;
GO
UPDATE TEACHER SET GENDER = 'ф' WHERE TEACHER_NAME = 'дпнгд юкейяеи хцнпебхв'
SELECT * FROM TR_AUDIT
------------------------------4>
...
INSERT INTO TEACHER(TEACHER,TEACHER_NAME,GENDER,PULPIT)
VALUES(1,2,4,4)
UPDATE TEACHER SET GENDER = '5' WHERE TEACHER_NAME = 'дпнгд юкейяеи хцнпебхв'
SELECT * FROM TR_AUDIT
------------------------------6>
...
RETURN;
GO
DELETE TEACHER WHERE TEACHER_NAME = 'дпнгд юкейяеи хцнпебхв'
...
END;
RETURN;
INSERT INTO PULPIT(PULPIT) VALUES ('юабц');
-----------------------------8>
...
begin
print 'рХО ЯНАШРХЪ: ' + @t;
print 'хЛЪ НАЗЕЙРЮ: ' + @t1;
print 'рХО НАЗЕЙРЮ: ' + @t2;
raiserror ('нОЕПЮЖХХ Я РЮАКХЖЕИ TEACHER ГЮОПЕЫЕМШ',16,1);
rollback;
end;
